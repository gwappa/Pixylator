                ...
                ParameterModel
{
    ...
    private static final String PANEL_TITLE    = "Histogram";

    public static final int INITIAL_SAMPLE_NUMBER   = 500000;

    // role field used for ParameterListner
    public static final String SAMPLE_NUMBER        = "sample_number";

    // action commands used for ActionDelegate
    ...
    public void setSampleNumber(int number)
    {
        ...
        _notifier.notifyParameterUpdate(SAMPLE_NUMBER, _number);
    }
    ...
    public void addParameterListener(ParameterListener l, String role){
        ...
        l.parameterUpdate(this, role, SAMPLE_NUMBER, getSampleNumber());
    }
